...
If you add agentic development workflows, entrypoints may also call into `src/agents/` to orchestrate tasks while still keeping the heavy lifting in reusable modules.
